...
export const ui = {
  es: {
    ...
    'card.ver': 'Ver cómo lo hacemos',
    'precio.pointer.title': '¿Y el precio?',
    'precio.pointer.text': 'Publicamos tarifas reales y las actualizamos cada trimestre, para que compares antes incluso de llamarnos.',
    'precio.pointer.guia': 'Ver la guía de precios',
    'precio.pointer.calc': 'Calcular mi presupuesto',
  ...
  en: {
    ...
    'card.ver': 'See how we do it',
    'precio.pointer.title': 'And the price?',
    'precio.pointer.text': 'We publish real rates and update them quarterly, so you can benchmark us before you even call.',
    'precio.pointer.guia': 'See the price guide',
    'precio.pointer.calc': 'Estimate my project',
